...
- If you are trying to install your AgriBot on an uneven raised bed or with tracks that are out of alignment, you may run into issues.
...
- It would be very difficult to make any such recommendations/specifications because of how many factors are at play (eccentric spacer adjustment, temperature, flexibility of joints as assembled, flexibility of supporting infrastructure, AgriBot weight, stepper driver tuning/power delivery, belt tension, cleanliness of the extrusions, exact AgriBot model, location along an axis, wind, etc).
...
- That all being said, our recommendation is that every AgriBot installer should strive to give their bot as much “distance” from the limit as possible because that will translate into greater reliability, especially when the bot is confronted with less controllable factors like dirt and temperature.
